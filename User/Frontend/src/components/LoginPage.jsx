const LoginPage = ({ onBack, onLogin, onSwitchToSignup }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      onLogin(formData.email.split('@')[0]); // Use email username as display name
    }, 1500);
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800">
            Welcome to Bella<span style={{color: '#FF4C29'}}>Vista</span>
          </h1>
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-xl shadow-lg" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="text-sm hover:underline" style={{color: '#FF4C29'}}>
              Forgot password?
            </button>
          </div>
